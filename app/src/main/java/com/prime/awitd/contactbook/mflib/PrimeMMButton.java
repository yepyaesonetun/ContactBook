...
public class PrimeMMButton extends Button {

    public PrimeMMButton(Context context) {
        super(context);
        setMMText(getText().toString());
    }

    public PrimeMMButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        setMMText(getText().toString());
    }

    public PrimeMMButton(Context context, AttributeSet attrs, int defStyle) {
